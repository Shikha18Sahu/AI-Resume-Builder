 ...
 const CreateCard = ({ card }) => (
  ...
  return (
   ...
   <BookUserIcon className="size-4.5 stroke-blue-600"/>
        ...
        <Title title="Don't just take our words" description = "Here what our users say about us. We're always looking for ways to improve. If you have a positive experience, we'd love to hear from you!" />
