  ...
  const templates = [
    ...
    },
    {
    ...
    },
     {
      id: "minimal",
      name: "Minimal",
      preview: "Ultra-clean design that puts you content front and center. "
    },
  ]
  return (
    <div className='relative'>
      ...
      {isOpen && (
        <div className='absolute top-full w-xs p-3 space-y-3 z-10 bg-white rounded-md border border-gray-200 shadow-sm'>
